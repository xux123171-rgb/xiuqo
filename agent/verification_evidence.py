...
_AD_HOC_SCRIPT_NAME_PREFIXES = ("xiuqo-verify-", "xiuqo-ad-hoc-")
...
def record_verify_run(
    *, root: str | Path, session_id: str | None = None, ok: bool, command: str = "xiuqo verify",
    scope: str = "full", output: str = "",
) -> Optional[dict[str, Any]]:
    """Record a completed ``xiuqo verify`` run as verification evidence.
    ...
    return _insert_evidence(VerificationEvidence(
        command=command, canonical_command="xiuqo verify", kind="verify",
