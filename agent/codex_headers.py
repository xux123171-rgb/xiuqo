...
def codex_cloudflare_headers(access_token: str, *, base_url: str = CODEX_AUX_BASE_URL) -> Dict[str, str]:
    ...
    endpoint gets Xiuqo' originator and version, custom endpoints keep the
    ...
    if is_official_codex_base_url(base_url):
        ...
        headers = {"User-Agent": f"XiuqoAgent/{__version__}", "originator": "xiuqo"}
    else:
        headers = {"User-Agent": "codex_cli_rs/0.0.0 (Xiuqo Agent)", "originator": "codex_cli_rs"}
