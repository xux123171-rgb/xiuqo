...
_IDENTICAL_CALL_NOTICE = (
    "[xiuqo note: this is the {ordinal} consecutive identical call to "
...
_IDENTICAL_CYCLE_NOTICE = (
    "[xiuqo note: the last {count} rounds repeated the same cycle of {period} tool calls "
...
class ToolCallGuardrailController:
    ...
    def _build_result_reference_stub(self, tool_name: str, args: Mapping[str, Any] | None) -> str:
        ...
        stub = (
            f"[xiuqo note: this result is byte-identical to the {tool_name} "
