...
_CA_BUNDLE_ENV_VARS = ("XIUQO_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "CURL_CA_BUNDLE")
_REPAIR_HINT = (
    "Repair: run `xiuqo doctor --fix` (auto-reinstalls certifi), or "
...
def verify_ca_bundle() -> None:
    ...
    is missing/corrupt."""
    if is_truthy_value(os.getenv("XIUQO_SKIP_SSL_GUARD", "")):
        logger.debug("SSL CA bundle guard skipped via XIUQO_SKIP_SSL_GUARD")
        return
