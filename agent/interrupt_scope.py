...
A host that runs a blocking command on a worker thread (Xiuqo Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("xiuqo_interrupt_scope", default=None)
