...
_SESSION_CWD: ContextVar = ContextVar("XIUQO_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Xiuqo source tree, a
    legitimate workspace when developing Xiuqo; fallback-directory policy lives in the caller."""
