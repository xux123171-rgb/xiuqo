...
class BitwardenLoginBackend(LoginBackend):
    ...
    def unlock(self, master_password: str) -> None:
        ...
        proc = run_with_secret_env([str(self._bw()), "unlock", "--raw", "--nointeraction", "--passwordenv", "XIUQO_BW_MASTER"],
                                   env=self._env(None), secret_env="XIUQO_BW_MASTER", secret=master_password,
