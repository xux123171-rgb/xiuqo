...
def export_current_turn_boundary(agent: Any, result: Any, user_message: Any) -> Any:
    ...
    Hosts that settle their own transcript by index (xiuqo-webui) must never guess which
...
def build_turn_context(
    ...
    # Tag log records on this thread with the session ID for ``xiuqo logs``; bind the
