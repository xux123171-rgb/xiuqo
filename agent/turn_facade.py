...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from xiuqo_cli.observability.relay_shared_metrics import finish_task_run, start_task_run
        ...
        try:
            ...
            # A host that owns this thread (Xiuqo Console) may cancel the turn cross-thread.
