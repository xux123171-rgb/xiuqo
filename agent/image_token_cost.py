...
The learned value is kept per ``model@host`` in ``~/.xiuqo/cache/image_token_costs.json`` so a new
...
_image_cost_var: ContextVar[Optional[int]] = ContextVar("xiuqo_image_token_cost", default=None)
