...
from xiuqo_state_common import _BOUNDARY_END_REASONS

# Hidden from browsing/searching — integrations (XIUQO_SESSION_SOURCE=tool), delegate
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past conversations: search or read old Xiuqo sessions (FTS5), or "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Xiuqo profile's database "
