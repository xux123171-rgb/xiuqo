...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in xiuqo dev work '
    ...
    "skill_view(name='github/xiuqo-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `xiuqo -z`, a cron '
...
# proc_session attribute -> XIUQO_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "XIUQO_SESSION_CHAT_ID"),
    ("watcher_user_id", "XIUQO_SESSION_USER_ID"),
    ("watcher_user_name", "XIUQO_SESSION_USER_NAME"),
    ("watcher_thread_id", "XIUQO_SESSION_THREAD_ID"),
    ("watcher_message_id", "XIUQO_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "XIUQO_SESSION_ID"),
)
