...
# containing `cat ~/.xiuqo/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `xiuqo-dev` skill contains a security postmortem mentioning `cat ~/.xiuqo/.env`, which tripped
