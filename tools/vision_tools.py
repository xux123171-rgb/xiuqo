...
_VISION_DOWNLOAD_TIMEOUT = _read_vision_setting("XIUQO_VISION_DOWNLOAD_TIMEOUT", "download_timeout", float)
...
def _resolve_vision_cpu_workers() -> int:
    """XIUQO_VISION_MAX_CONCURRENCY → ``auxiliary.vision.max_concurrency`` → host cores (< 1 ignored)."""
    val = _read_vision_setting("XIUQO_VISION_MAX_CONCURRENCY", "max_concurrency", int, minimum=1)
...
async def vision_analyze_tool(
    ...
    is pre-formatted by the caller. Temp images live under $XIUQO_HOME/cache/vision/."""
