...
# GigaSpeech), downloaded once under XIUQO_HOME. Keywords are tokenized at RUNTIME.
...
class _SherpaKwsEngine(_Engine):
    ...
    def _build(self, cfg, sub, ww) -> None:
        ...
        phrase = str(ww._get(cfg, "phrase") or "hey xiuqo").strip()
        ...
        kw = tempfile.NamedTemporaryFile(mode="w", suffix=".txt", prefix="xiuqo-kws-", delete=False,
                                         encoding="utf-8")
