...
LOCAL_STT_COMMAND_ENV = "XIUQO_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "XIUQO_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via xiuqo_cli.models.deepinfra_base_url (shared).
