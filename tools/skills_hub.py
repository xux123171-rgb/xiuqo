...
Used by xiuqo_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "XIUQO_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"XIUQO_HOME": _hermes_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'XIUQO_INDEX_TTL': ('tools.skills_hub_search', 'XIUQO_INDEX_TTL'),
    'XIUQO_INDEX_URL': ('tools.skills_hub_search', 'XIUQO_INDEX_URL'),
