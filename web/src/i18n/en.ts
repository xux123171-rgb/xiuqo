...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Xiuqo",
    updateHermesConfirmMessage:
      "This runs xiuqo update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Xiuqo?",
    updatingHermes: "Updating Xiuqo…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Xiuqo plugins (`xiuqo plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.xiuqo/plugins/?",
    removeHint: "Only user-installed plugins under ~/.xiuqo/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Xiuqo plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.xiuqo/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Xiuqo doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Xiuqo Achievements",
      subtitle:
        "Collectible Xiuqo badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Xiuqo session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Xiuqo more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Xiuqo sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Xiuqo is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Xiuqo Agent ☤",
    },
  },
