import { applyDocumentLocale, LOCALE_ENDONYMS } from "@xiuqo/shared/i18n";
...
// Display metadata for the language picker — endonyms from @xiuqo/shared so the
...
const STORAGE_KEY = "xiuqo-locale";
