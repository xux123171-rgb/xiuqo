 ...
 *
 * Plugins call window.__XIUQO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__XIUQO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__XIUQO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__XIUQO_PLUGIN_SDK__ = {
    ...
    // window.__XIUQO_SESSION_TOKEN__ directly.
    authedFetch,
