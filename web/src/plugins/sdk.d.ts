/**
 * Xiuqo Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__XIUQO_PLUGIN_SDK__`` and
 * ``window.__XIUQO_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__XIUQO_PLUGIN_SDK__`` because:
 ...
 *   - Ship as a published ``@xiuqo/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__XIUQO_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__XIUQO_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__XIUQO_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __XIUQO_PLUGIN_SDK__?: HermesPluginSDK;
    __XIUQO_PLUGINS__?: PluginRegistry;
  }
}
