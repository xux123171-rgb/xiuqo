...
const STORAGE_KEY = "xiuqo-dashboard-theme";
...
const FONT_STORAGE_KEY = "xiuqo-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `xiuqo_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "xiuqo-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-xiuqo-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-xiuqo-theme-font", "true");
