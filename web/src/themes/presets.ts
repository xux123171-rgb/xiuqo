import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@xiuqo/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `xiuqo_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@xiuqo/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Xiuqo Teal",
  description: "Classic dark teal — the canonical Xiuqo look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Xiuqo Teal (Large)",
  description: "Xiuqo Teal with bigger fonts and roomier spacing",
