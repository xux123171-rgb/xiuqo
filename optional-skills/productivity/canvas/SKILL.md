...
4. Name the token (e.g., "Xiuqo Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${XIUQO_HOME:-~/.xiuqo}/.env`:
...
```bash
CANVAS="python $XIUQO_HOME/skills/productivity/canvas/scripts/canvas_api.py"
