...
Present researched properties as browsable cards in the Xiuqo desktop transcript.
...
- A Xiuqo desktop conversation for native cards; the backend may be local or remote.
...
```text
xiuqo skills install official/productivity/property-listings
```
