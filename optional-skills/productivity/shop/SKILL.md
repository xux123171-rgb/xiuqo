...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), Xiuqo Agent
license: MIT
...
| Telegram (Xiuqo Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
