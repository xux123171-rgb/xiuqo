...
Data file: $XIUQO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_XIUQO_HOME = Path(os.environ.get("XIUQO_HOME", Path.home() / ".xiuqo"))
DATA_DIR = _XIUQO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
