...
version: 2.0.0
author: "Rafael Zendron (rafaumeu) + Matt Pocock (mattpocock/skills, grilling) + Xiuqo Agent"
license: MIT
...
1. **Asking questions out of dependency order.** A question that depends on
   ...
   later round.
2. **Skipping the codebase.** Find facts in code with Xiuqo tools instead of
   asking the user.
