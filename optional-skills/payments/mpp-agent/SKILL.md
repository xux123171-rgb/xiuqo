...
Wraps the Machine Payments Protocol (MPP, https://mpp.dev) clients so Xiuqo can pay for per-request API access against servers that respond with `HTTP 402 Payment Required`.
