...
```bash
python -m pyfiglet "XIUQO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=XIUQO&font=Slant" | boxes -d stone
```
