...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.xiuqo/skills/creative/pixel-art/scripts"))
...
```bash
cd ~/.xiuqo/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Xiuqo installs package this)
