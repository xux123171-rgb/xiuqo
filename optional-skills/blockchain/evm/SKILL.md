...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Xiuqo Agent
license: MIT
...
Helper script path: `~/.xiuqo/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.xiuqo/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.xiuqo/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.xiuqo/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
