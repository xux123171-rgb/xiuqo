...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Xiuqo Agent
license: MIT
...
Helper script path: ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.xiuqo/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
