...
author: Xiuqo Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
license: MIT
metadata:
  xiuqo:
...
# $XIUQO_OSINT_CACHE/icij/ (default: ~/.cache/xiuqo-osint/icij/).
...
# Set XIUQO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
