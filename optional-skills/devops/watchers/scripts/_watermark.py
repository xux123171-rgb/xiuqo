...
def _state_dir() -> Path:
    ...
    # Default: $XIUQO_HOME/watcher-state/, falling back to ~/.xiuqo/watcher-state/.
    xiuqo_home = os.environ.get("XIUQO_HOME") or str(Path.home() / ".xiuqo")
    return Path(xiuqo_home) / "watcher-state"
