...
version: 0.1.0
author: Mibay (Mibayy), Xiuqo Agent
license: MIT
...
```
SCRIPT=~/.xiuqo/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.xiuqo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
