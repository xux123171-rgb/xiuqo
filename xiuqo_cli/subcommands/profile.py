"""``xiuqo profile`` subcommand parser."""
...
def build_profile_parser(subparsers, *, cmd_profile: Callable) -> None:
    ...
    profile_parser = subparsers.add_parser(
        "profile", help="Manage profiles — multiple isolated Xiuqo instances")
    ...
    profile_create.add_argument(
        ...
        help="Create an empty profile with no bundled skills (opts out of `xiuqo update` skill sync)",
    )
    profile_create.add_argument(
        ...
        help="One- or two-sentence description of what this profile is good at. "
             ...
             "of profile name alone. Skip and add later via `xiuqo profile describe`.")
    ...
    profile_install = profile_subparsers.add_parser(
        ...
        description="Install a Xiuqo profile distribution. SOURCE can be a git URL "
