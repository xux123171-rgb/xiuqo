"""``xiuqo secrets`` subcommand parser."""
...
def build_secrets_parser(subparsers) -> None:
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description="Pull API keys from an external secret manager at process startup "
            "instead of storing them in ~/.xiuqo/.env.  Supports Bitwarden "
    ...
    from xiuqo_cli import secrets_cli as _secrets_cli
    from xiuqo_cli import onepassword_secrets_cli as _op_secrets_cli
