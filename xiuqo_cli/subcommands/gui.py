...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Xiuqo Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any xiuqo CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--xiuqo-root",
        help="Override the Xiuqo source root used by Desktop (sets XIUQO_DESKTOP_XIUQO_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets XIUQO_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Xiuqo Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Xiuqo Local Signing)",
    )
