"""``xiuqo uninstall`` subcommand parser."""
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall", help="Uninstall Xiuqo Agent",
        description="Remove Xiuqo Agent from your system. Can keep configs/data for reinstall.")
