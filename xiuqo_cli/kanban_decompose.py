...
Invoked by ``xiuqo kanban decompose [task_id | --all]`` and the gateway
...
from xiuqo_cli.kanban_db_graph import decompose_triage_task
from xiuqo_cli import kanban_db_connect as kbc
from xiuqo_cli import profiles as profiles_mod
from xiuqo_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from xiuqo_cli.kanban_specify import _profile_author as _specify_author

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban decomposer for the Xiuqo Agent board.
...
def _profile_author() -> str:
    """Mirror of ``xiuqo_cli.kanban._profile_author``."""
