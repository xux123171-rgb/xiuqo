...
from xiuqo_cli.config import get_config_path, read_raw_config
from xiuqo_cli.web_deps import late
from xiuqo_cli.web_routers._common import corrupt_store_as_status
...
from xiuqo_cli.web_models import RawConfigUpdate

router = APIRouter()

# Late-bound so a test's monkeypatch on the owning module wins at call time.
_open_session_db_for_profile = late("_open_session_db_for_profile", "xiuqo_cli.web_server_sessions")
_session_db_path_for_profile = late("_session_db_path_for_profile", "xiuqo_cli.web_server_sessions")
