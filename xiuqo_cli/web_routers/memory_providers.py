...
from xiuqo_cli.web_server_dashboard import _invalidate_plugins_hub_cache
from xiuqo_cli.web_server_memory import (
...
from xiuqo_cli.web_models import MemoryProviderConfigUpdate, MemoryProviderSetupRequest
...
_dependency_importable = late("_dependency_importable", "xiuqo_cli.web_server_memory")
...
def _install_memory_provider_pip_dependencies(dependencies: List[str]) -> List[Dict[str, Any]]:
    ...
    # read-only and installs must go to XIUQO_LAZY_INSTALL_TARGET, which
