"""Relay subscriber for the persisted Xiuqo shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Xiuqo counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Xiuqo shared metric: %s", metric_name, exc_info=True
                )
