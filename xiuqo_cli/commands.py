"""Slash command registry for the Xiuqo CLI and gateway.
...
from xiuqo_constants import INDICATOR_STYLES
...
class CommandDef:
    ...
    # Key in ``xiuqo_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Xiuqo config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Xiuqo works on across turns until achieved", "Session",
    ...
    CommandDef("plan", "Write a markdown implementation plan to .xiuqo/plans/ without executing anything", "Session",
               args_hint="[task]"),
    ...
    CommandDef("wake", "Toggle the 'Hey Xiuqo' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]", subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while Xiuqo is working", "Configuration",
    ...
    CommandDef("reload-skills", "Re-scan ~/.xiuqo/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update Xiuqo Agent to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Xiuqo Agent version", "Info", aliases=("v",),
...
def _collect_gateway_skill_entries(
    ...
    try:
        ...
        # ``xiuqo skills list`` and the agent's ``/skill-name`` dispatch but
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('xiuqo_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('xiuqo_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('xiuqo_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('xiuqo_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('xiuqo_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('xiuqo_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('xiuqo_cli.commands_platforms', 'telegram_menu_max_commands'),
}
