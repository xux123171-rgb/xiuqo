...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Xiuqo to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Xiuqo needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Xiuqo gateway in another terminal:",
        "         xiuqo gateway", "",
