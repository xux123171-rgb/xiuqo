...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    from xiuqo_cli.local_runtime.presets import preset_for_model, read_preset_decisions
