"""Shared migration guards for Xiuqo' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "XIUQO_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "XIUQO_NEMO_RELAY_ATOF_ENABLED",
    "XIUQO_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "XIUQO_NEMO_RELAY_ATOF_FILENAME",
    "XIUQO_NEMO_RELAY_ATOF_MODE",
    "XIUQO_NEMO_RELAY_ATIF_ENABLED",
    "XIUQO_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "XIUQO_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "XIUQO_NEMO_RELAY_ATIF_AGENT_NAME",
    "XIUQO_NEMO_RELAY_ATIF_AGENT_VERSION",
    "XIUQO_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "XIUQO_NEMO_RELAY_ATIF_MODEL_NAME",
    "XIUQO_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
