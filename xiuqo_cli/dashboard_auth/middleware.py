...
from xiuqo_cli.dashboard_auth import list_session_providers
from xiuqo_cli.dashboard_auth.audit import AuditEvent, audit_log
from xiuqo_cli.dashboard_auth.base import ProviderError
...
from xiuqo_cli.dashboard_auth.prefix import prefix_from_request
from xiuqo_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from xiuqo_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from xiuqo_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["xiuqo.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('xiuqo_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
