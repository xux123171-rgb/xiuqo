"""Plugin-owned durable state and namespaced settings helpers (split out of xiuqo_cli.plugins)."""
...
from xiuqo_cli.plugins_manifest import _portable_skill_namespace
