...
class CLIStatusBarMixin:
    ...
    def _get_status_bar_snapshot(self) -> Dict[str, Any]:
        ...
        try:
            from xiuqo_cli.focus_view import focus_statusbar_segment
        ...
        try:
            ...
            if _fields is not None and "git_branch" in _fields:
                from xiuqo_cli.status_bar_git import current_git_branch
    ...
    def _pet_resolve_config(self) -> None:
        """(Re)resolve the active pet from config so ``/pet`` / ``xiuqo pets`` changes apply
    ...
    def _build_status_bar_text(self, width: Optional[int] = None) -> str:
        ...
        try:
            ...
            return f"☤ {self.model if getattr(self, 'model', None) else 'Xiuqo'}"
