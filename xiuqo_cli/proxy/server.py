...
from xiuqo_cli.proxy.sse_done import DONE_SSE_FRAME, SseDoneTracker, content_type_is_sse
...
def _require_aiohttp() -> None:
    if not AIOHTTP_AVAILABLE:
        raise RuntimeError("aiohttp is required for `xiuqo proxy`. Run `xiuqo setup` to install it.")
