"""Default SOUL.md template seeded into XIUQO_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Xiuqo Agent, built by Nous Research. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    ...
    "The agent will embody whatever you write here.\nEdit this to customize how Xiuqo communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Xiuqo Agent, an intelligent AI assistant created by Nous Research. You are helpful, "
