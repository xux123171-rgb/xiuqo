"""Skills configuration for Xiuqo Agent. `xiuqo skills` enters this module."""
from typing import List, Optional, Set

from xiuqo_cli.config import cfg_get, load_config, save_config
from xiuqo_cli.colors import Colors, color
from xiuqo_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``xiuqo``) are
