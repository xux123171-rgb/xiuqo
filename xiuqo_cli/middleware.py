"""Xiuqo middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "xiuqo.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "xiuqo.middleware.v1"
...
def _apply_request_chain(
    ...
    from xiuqo_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from xiuqo_cli.plugins import has_middleware
