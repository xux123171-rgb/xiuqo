"""Non-interactive HTTPS credentials for Xiuqo's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``xiuqo plugins install`` with
