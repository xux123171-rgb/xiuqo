"""Xiuqo skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces XIUQO_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces XIUQO_CADUCEUS)
...
# Branding shared by every Xiuqo-named built-in (mono/daylight override help_header).
_XIUQO_BRANDING: Dict[str, str] = _branding(
    "Xiuqo", "☤", "Goodbye! ☤", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Xiuqo — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_XIUQO_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _XIUQO_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_hermes_home_override() is None else xiuqo_home_key()
