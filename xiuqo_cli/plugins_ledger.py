...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`xiuqo_cli.plugins.PluginManager`.
"""
...
from xiuqo_cli.plugins_loader import _plugin_home_scope
from xiuqo_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from xiuqo_cli.plugins import _PLUGINS_DEBUG
