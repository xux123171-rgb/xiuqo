...
from xiuqo_cli.anon_sign_in import Code, SignInState, UPGRADE_CANCELLED, UPGRADE_START
...
def render_sign_in_cli_code(
    ...
    from xiuqo_cli.auth_device_flow import _print_device_code_instructions
...
def upgrade_guest(args) -> int:
    """``xiuqo auth upgrade``: sign in with a Nous account, transferring the free tier's connectors.
    ...
    """
    from xiuqo_cli import anon_auth as _core
    from xiuqo_cli.auth_device_flow import _is_remote_session
