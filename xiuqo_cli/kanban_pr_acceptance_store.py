...
from xiuqo_cli.kanban_db_connect import write_txn
from xiuqo_cli.kanban_pr_acceptance import _PR, collect_acceptance
...
def record_acceptance(conn, task_id, acceptance):
    ...
    from xiuqo_cli.kanban_db import _append_event
