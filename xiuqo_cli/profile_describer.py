...
Mirrors ``xiuqo_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the Xiuqo Agent kanban board.
...
Rules:
  ...
  - Never write "Xiuqo Agent profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from xiuqo_cli.kanban_specify import _extract_json_blob as _extract
