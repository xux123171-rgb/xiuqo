...
backend): the requested profile's XIUQO_HOME and secret scope are bound around the body, so the
...
def _(rid, params: dict) -> dict:
    ...
    rows = [{"name": "local", "display_name": "Xiuqo vault", "enabled": True, "needs_unlock": False,
