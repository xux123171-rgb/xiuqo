...
def _foreign_list(rid, params):
    from xiuqo_cli.foreign_sessions_browser import list_foreign_sessions
    try:
...
def _foreign_history_request(rid, params, importing):
    from xiuqo_cli.foreign_sessions_browser import import_browser_session, preview_foreign_session
    try:
