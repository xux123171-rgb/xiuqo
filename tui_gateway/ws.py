...
def _sanitize_ws_text(text: str) -> str:
    ...
    closed. Same U+FFFD replacement every other Xiuqo transport applies.
...
async def handle_ws(ws: Any, *, auth_identity: dict | None = None, subprotocol: str | None = None) -> None:
    ...
    try:
        ...
        if ready_ok:
            # Live-apply skins Xiuqo activates mid-conversation, and track this peer for session-less
