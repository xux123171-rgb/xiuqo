...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the Xiuqo gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("XIUQO_PROFILE") or "default").strip() or "default"
