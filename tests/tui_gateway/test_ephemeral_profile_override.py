"""Regression tests: profile XIUQO_HOME override in ephemeral agent threads (#50233).
...
``XIUQO_HOME`` ContextVar set on the session-create thread does NOT propagate to
...
PROFILE_HOME = "/home/user/.xiuqo/profiles/work"
