...
from xiuqo_cli.local_runtime import endpoint
...
def local_route(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("xiuqo_cli.banner.get_update_result", lambda **kw: None)
    monkeypatch.setattr("xiuqo_cli.banner.get_available_skills", lambda: {})
