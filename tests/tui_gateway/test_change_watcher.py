...
Behavior contracts, exercised against a real temp XIUQO_HOME (no mocks on the
...
def test_served_profile_store_move_broadcasts_sessions_changed(watcher_home, monkeypatch):
    ...
    monkeypatch.setattr("xiuqo_cli.profiles.get_profile_dir", lambda name: home / "profiles" / name)
