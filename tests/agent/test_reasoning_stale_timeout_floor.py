...
thinking phase.  Xiuqo's default cloud-stream stale detector
(``XIUQO_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``XIUQO_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
