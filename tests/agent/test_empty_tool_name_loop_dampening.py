...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated XIUQO_HOME, yield (agent, helpers)."""
    ...
    test_home = tempfile.mkdtemp(prefix="xiuqo_e2e_47967_")
    ...
    try:
        ...
        # references into xiuqo_cli.*/tools.* and their monkeypatches would otherwise
