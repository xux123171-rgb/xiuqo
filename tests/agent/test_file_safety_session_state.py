...
manipulation. Xiuqo keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point XIUQO_HOME at a temp profile dir.
    ...
    XIUQO_HOME=<root>/profiles/<name> makes get_default_hermes_root()
