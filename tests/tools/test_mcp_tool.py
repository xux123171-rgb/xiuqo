...
class TestLoadMCPConfig:
    ...
    def test_valid_config_parsed(self):
        ...
        with patch("xiuqo_cli.config.load_config", return_value={"mcp_servers": servers}):
    ...
    def test_mcp_servers_not_dict_returns_empty(self):
        ...
        with patch("xiuqo_cli.config.load_config", return_value={"mcp_servers": "invalid"}):
            from tools.mcp_tool_config import _load_mcp_config
            result = _load_mcp_config()
            assert result == {}
    ...
    def test_portable_servers_merge_after_native_interpolation(self):
        ...
        with (
            patch("xiuqo_cli.config.load_config", return_value={"mcp_servers": native}),
            patch("xiuqo_cli.plugins.discover_plugins"),
            patch("xiuqo_cli.plugins.get_plugin_manager", return_value=manager),
...
class TestToolsetInjection:
    ...
    def test_partial_failure_retry_on_second_call(self):
        ...
        fake_toolsets = {
            "xiuqo-cli": {"tools": [], "description": "CLI", "includes": []},
        }
