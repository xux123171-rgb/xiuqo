...
class TestTerminalIntegration:
    ...
    def test_blocklisted_var_blocked_by_default(self):
        ...
        blocked_var = next(iter(_XIUQO_PROVIDER_ENV_BLOCKLIST))
    ...
    def test_passthrough_cannot_override_provider_blocklist(self):
        ...
        Xiuqo provider credentials — that was the bypass where a skill
    ...
    def test_passthrough_cannot_override_internal_dynamic_secret(self):
        """A skill must NOT be able to register dynamically-named Xiuqo
    ...
    def test_non_hermes_api_key_still_registerable(self):
        ...
        Xiuqo provider credentials and must still pass through — skills
    ...
    def test_provider_blocklist_import_failure_fails_closed(self, monkeypatch):
        ...
        otherwise a skill could tunnel a Xiuqo credential into the
        ...
        it out of the child env. A non-Xiuqo key is also rejected here (the
