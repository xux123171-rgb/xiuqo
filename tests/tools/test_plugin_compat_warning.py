...
Kept alongside the compat layer (tests/xiuqo_cli/test_compat_manifest_targets.py); both are deleted with it.
"""
import importlib
import json
import warnings
...
def test_compat_resolution_warns_once_per_name_with_the_new_location():
    from xiuqo_cli.plugin_compat import HermesPluginCompatWarning, _seen
...
def test_importing_the_facade_itself_does_not_warn():
    ...
    from xiuqo_cli.plugin_compat import HermesPluginCompatWarning
    import sys
