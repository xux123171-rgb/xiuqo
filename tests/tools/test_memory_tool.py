...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/xiuqo config files without modify intent.
        ...
        assert _scan_memory_content("Read .xiuqo/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .xiuqo/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .xiuqo/config.yaml to change settings", "xiuqo_config_mod")
        _blocked("update .xiuqo/SOUL.md with new personality", "xiuqo_config_mod")
