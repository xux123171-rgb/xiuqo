...
Verifies that:
 ...
 2. User plugins at $XIUQO_HOME/plugins/model-providers/<name>/ override bundled
...
def test_user_plugin_overrides_bundled(tmp_path, monkeypatch):
    ...
    # Point XIUQO_HOME at a fresh temp dir
    ...
    user_gmi = xiuqo_home / "plugins" / "model-providers" / "gmi"
