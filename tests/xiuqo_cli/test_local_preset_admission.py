...
from xiuqo_cli.local_runtime import presets, supervisor
from xiuqo_cli.local_runtime.estimator import HardwareBudget, ModelProfile
...
def test_optional_draft_is_enabled_only_with_room_at_the_selected_window(tmp_path, monkeypatch):
    ...
    from xiuqo_cli.local_runtime import bootstrap, catalog
    ...
    from xiuqo_cli.local_runtime.estimator import LayerKind, ctx_bytes
