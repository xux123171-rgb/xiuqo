"""Tests for the shared byte formatter (xiuqo_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from xiuqo_cli.backup import _format_size as backup
    from xiuqo_cli.checkpoints import _fmt_bytes as checkpoints
    from xiuqo_cli.sizefmt import format_bytes as doctor
