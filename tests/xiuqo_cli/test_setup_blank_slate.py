"""Tests for Blank Slate setup mode (xiuqo_cli/setup.py).
...
from xiuqo_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
