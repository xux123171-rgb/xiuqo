...
Profile-aware location: ``$XIUQO_HOME/logs/dashboard-auth.log``.
...
from xiuqo_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $XIUQO_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".xiuqo"
    home.mkdir()
