...
from xiuqo_cli.dashboard_auth import refresh_singleflight as replay
from xiuqo_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from xiuqo_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"xiuqo_session_at": "expired-at", "xiuqo_session_rt": "stale-rt",
               "xiuqo_session_provider": "stub"}
