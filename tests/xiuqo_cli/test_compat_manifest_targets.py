...
Regression: ``xiuqo_cli.kanban_db.connect`` was pointed at ``xiuqo_cli.projects_db.connect`` (a different
...
def test_kanban_db_connect_opens_a_kanban_board(tmp_path, monkeypatch):
    ...
    import xiuqo_cli.kanban_db as kanban_db
    import xiuqo_cli.kanban_db_connect as kanban_db_connect
