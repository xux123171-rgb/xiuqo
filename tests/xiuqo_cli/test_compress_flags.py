...
Covers the pure helpers in ``xiuqo_cli.partial_compress`` plus alias
...
from xiuqo_cli.commands import COMMANDS, resolve_command
from xiuqo_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
