"""Fetch-failure classification for `xiuqo update` / `xiuqo update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/xux123171-rgb/xiuqo.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `xiuqo update` sit on
    ...
    from xiuqo_cli import update_cmd_git
