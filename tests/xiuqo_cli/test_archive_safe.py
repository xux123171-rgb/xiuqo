"""Tests for the shared tar.gz writer (``xiuqo_cli.archive_safe.make_targz``).

``make_targz`` backs both ``xiuqo profile export`` and ``xiuqo kanban
...
from xiuqo_cli.archive_safe import make_targz
