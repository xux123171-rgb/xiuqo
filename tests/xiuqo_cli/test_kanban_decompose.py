"""Tests for the decomposer module + `xiuqo kanban decompose` CLI surface.
...
def _patch_list_profiles(names: list[str]):
    ...
    return [
        patch("xiuqo_cli.profiles.list_profiles", return_value=fake_profiles),
        patch("xiuqo_cli.profiles.profile_exists", side_effect=lambda x: x in names),
        patch("xiuqo_cli.profiles.get_active_profile_name", return_value=names[0] if names else "default"),
    ]
