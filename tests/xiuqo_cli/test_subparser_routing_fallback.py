...
The main() function in xiuqo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `xiuqo -c model`
...
def _build_parser():
    """Build a minimal replica of the xiuqo top-level parser."""
