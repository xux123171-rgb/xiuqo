...
def _run_switch(raw_input: str, current_provider: str = "openrouter") -> str:
    ...
    with patch("xiuqo_cli.model_switch.resolve_alias", return_value=None), \
         ...
         patch("xiuqo_cli.models_validate.validate_requested_model", return_value=_MOCK_VALIDATION), \
...
class TestColonFormOffAggregators:
    ...
    def test_known_provider_colon_matches_slash_form(self):
        with patch("xiuqo_cli.model_switch.resolve_provider_full", return_value=None):
