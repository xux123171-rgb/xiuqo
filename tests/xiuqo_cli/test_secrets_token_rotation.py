"""Tests for `xiuqo secrets bitwarden token` / `xiuqo secrets onepassword token`.
...
from xiuqo_cli import onepassword_secrets_cli as op_cli
from xiuqo_cli import secrets_cli as bw_cli
