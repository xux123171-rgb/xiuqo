...
def test_message_pages_identify_the_serving_profile(tmp_path, monkeypatch, serving_profile):
    ...
    monkeypatch.setenv("XIUQO_HOME", str(work_home))
    # conftest redirects this legacy override independently of XIUQO_HOME.
    monkeypatch.setattr("xiuqo_state.DEFAULT_DB_PATH", work_home / "state.db")
    ...
    from xiuqo_cli.web_routers.sessions import manage_router
