...
from xiuqo_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/xiuqo_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("xiuqo_cli.lifecycle.invoke_hook")
@patch("xiuqo_cli.lifecycle.finalize_session")
