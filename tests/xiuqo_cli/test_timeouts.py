...
from xiuqo_cli.timeouts import (
...
def test_resolved_api_call_timeout_priority(monkeypatch, tmp_path):
          ...
          openrouter:
            ...
            models:
              openai/gpt-4o-mini:
                timeout_seconds: 42
        """)
    monkeypatch.setenv("XIUQO_API_TIMEOUT", "999")
    ...
    from xiuqo_cli import timeouts as to_mod
    ...
    monkeypatch.delenv("XIUQO_API_TIMEOUT", raising=False)
