"""Tests for the Command Installation check in xiuqo doctor."""
...
import xiuqo_cli.doctor as doctor_mod


def _setup_doctor_env(monkeypatch, tmp_path, venv_name="venv"):
    """Create a minimal XIUQO_HOME + PROJECT_ROOT for doctor tests."""
    home = tmp_path / ".xiuqo"
    ...
    xiuqo_bin = venv_bin_dir / "xiuqo"
    xiuqo_bin.write_text("#!/usr/bin/env python\n# entry point\n")
...
class TestDoctorCommandInstallation:
    ...
    def test_fix_repairs_wrong_symlink(self, monkeypatch, tmp_path):
        ...
        assert cmd_link.resolve() == xiuqo_bin.resolve()
