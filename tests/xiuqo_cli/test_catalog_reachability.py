...
Run before any catalog commit:
    ...
    XIUQO_TEST_NETWORK=1 scripts/run_tests.sh tests/xiuqo_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("XIUQO_TEST_NETWORK"),
    reason="network test; set XIUQO_TEST_NETWORK=1 to run",
)
