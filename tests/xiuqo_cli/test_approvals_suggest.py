"""Tests for ``xiuqo approvals suggest`` (xiuqo_cli/approvals_suggest.py).

Approval history in Xiuqo is implied, not ledgered: the session DB
...
from xiuqo_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
