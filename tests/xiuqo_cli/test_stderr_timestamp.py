"""Tests for xiuqo_cli.stderr_timestamp."""
...
from xiuqo_cli import stderr_timestamp
...
_LAUNCHD_ENV = {"PATH": "/usr/bin", "XPC_SERVICE_NAME": "ai.xiuqo.gateway-butler"}
...
def test_main_injects_flag_into_stale_gateway_child(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("XPC_SERVICE_NAME", "ai.xiuqo.gateway-butler")
    ...
    stale = [sys.executable, "-c", code, "-m", "xiuqo_cli.main", "gateway", "run", "--replace"]
