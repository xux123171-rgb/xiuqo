...
The state machine itself is covered by tests/xiuqo_cli/test_prompt_stash.py. These
...
tests/xiuqo_cli/test_cli_extension_hooks.py.
"""
...
class TestStashStateInit:
    ...
    def test_stash_starts_empty(self, cli):
        ...
        # module, which re-imports xiuqo_cli.prompt_toolkit stubs and can
