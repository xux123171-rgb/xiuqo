"""Tests for xiuqo_cli.foreign_sessions — Claude Code / Codex CLI import.

Fixture JSONL is synthesized inline (tmp_path); the SessionDB is opened
against a temp path so nothing touches the real XIUQO_HOME store.
"""
...
from xiuqo_cli.foreign_sessions import (
    _list_sessions,
