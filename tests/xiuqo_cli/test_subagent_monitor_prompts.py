...
def test_prompt_paint_yields_monitor_but_ordinary_paint_does_not(monkeypatch, paint_source):
    from xiuqo_cli.cli_subagent_monitor import SubagentMonitor, build_monitor_application, install_dock
...
def test_secret_callback_yields_monitor_and_restores_composer():
    from xiuqo_cli.cli_subagent_monitor import SubagentMonitor, build_monitor_application
    from xiuqo_cli.cli_terminal_mixin import CLITerminalMixin
