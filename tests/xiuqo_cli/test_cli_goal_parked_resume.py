...
def test_idle_hook_queues_the_continuation_when_a_timed_barrier_has_elapsed(xiuqo_home):
...
def test_idle_hook_is_a_no_op_for_an_unparked_or_inactive_goal(xiuqo_home):
