...
from xiuqo_cli.web_server_gateway import _collect_profile_gateway_topology, _profile_platform_ports
...
class TestStatusEndpointTopology:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Xiuqo Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside xiuqo_home / gateway_pid.
            assert "gateways" not in data
            assert "xiuqo_home" not in data
