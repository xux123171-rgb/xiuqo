"""Regression test: xiuqo update must not load cryptography eagerly."""
...
assert 'xiuqo_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running xiuqo update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so xiuqo_cli is importable,
