...
Every surface renders through ``xiuqo_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("xiuqo_constants.display_hermes_home", return_value=HOME), \
