...
class TestGetCopilotModelContext:
    ...
    @patch("xiuqo_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("xiuqo_cli.models._urlopen_model_catalog_request")
    ...
    @patch("xiuqo_cli.models.fetch_github_model_catalog", return_value=[])
