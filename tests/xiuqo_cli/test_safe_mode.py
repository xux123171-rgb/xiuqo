"""Tests for `xiuqo chat --safe-mode` isolation."""
...
_VARS = ("XIUQO_SAFE_MODE", "XIUQO_IGNORE_USER_CONFIG", "XIUQO_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["XIUQO_SAFE_MODE"] == "1"
        assert os.environ["XIUQO_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["XIUQO_IGNORE_RULES"] == "1"
        return True
