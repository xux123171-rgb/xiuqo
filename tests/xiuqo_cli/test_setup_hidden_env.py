...
from xiuqo_cli.setup_hidden_env import is_setup_hidden_env
...
class TestChannelCards:
    def test_discord_card_asks_for_token_and_allowlist_only(self):
        ...
        from xiuqo_cli.web_server_messaging import _build_catalog_entry
    ...
    def test_hidden_knobs_move_to_the_keys_page_not_into_a_void(self):
        ...
        from xiuqo_cli.web_server_messaging import _channel_managed_env_keys
...
class TestCliWizard:
    """`xiuqo setup gateway` drops the same knobs. Real wizard, scripted
    stdin, real .env writes under a temp XIUQO_HOME."""
