...
from xiuqo_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
from xiuqo_cli.commands_completion import SlashCommandCompleter
from xiuqo_cli.commands_platforms import telegram_bot_commands
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("XIUQO_MANAGED_DIR", str(home / "missing-managed"))
    from xiuqo_cli import managed_scope
    from xiuqo_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
