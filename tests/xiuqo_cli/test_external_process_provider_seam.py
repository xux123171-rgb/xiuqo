...
way a standalone package does — before importing ``xiuqo_cli`` — and walks the
...
def test_an_out_of_tree_external_process_provider_resolves_end_to_end(fake_cli, monkeypatch):
    from xiuqo_cli.auth import PROVIDER_REGISTRY, resolve_external_process_provider_credentials, resolve_provider
