"""Tests for the specifier module + `xiuqo kanban specify` CLI surface.
...
from xiuqo_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `xiuqo kanban …` argparse surface directly."""
