"""Tests for the ``xiuqo prompt-size`` diagnostic (issue #34667)."""
...
from xiuqo_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(xiuqo_home, memory_text="", user_text=""):
    mem_dir = xiuqo_home / "memories"
...
def _seed_skill(xiuqo_home, name, description):
    skill_dir = xiuqo_home / "skills" / "demo" / name
