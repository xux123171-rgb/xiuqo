...
import xiuqo_cli.model_switch_providers as xiuqo_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(xiuqo_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("xiuqo_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import xiuqo_cli.models as hm
    import xiuqo_cli.models_catalog_static as xiuqo_cli_models_catalog_static
    from xiuqo_cli import models_catalog_static
    ...
    monkeypatch.setattr(xiuqo_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
