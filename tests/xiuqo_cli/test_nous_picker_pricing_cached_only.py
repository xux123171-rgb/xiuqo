...
import xiuqo_cli.models_pricing as mp
...
def test_nous_picker_model_ids_reads_pricing_cache_only(monkeypatch):
    ...
    monkeypatch.setattr("xiuqo_cli.models.check_nous_free_tier", lambda **kw: False)
    monkeypatch.setattr("xiuqo_cli.models.fetch_nous_recommended_models", lambda *a, **kw: None)
