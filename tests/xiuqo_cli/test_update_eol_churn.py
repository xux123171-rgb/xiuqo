"""Regression: ``xiuqo update`` should take a managed checkout off autocrlf=true.
...
``xiuqo update`` has to repair them.
...
from xiuqo_cli.update_cmd import _normalize_managed_eol
