...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`xiuqo_cli.slash_exec.EXECUTORS`, and
...
from xiuqo_cli.commands import COMMAND_REGISTRY, resolve_command
from xiuqo_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
