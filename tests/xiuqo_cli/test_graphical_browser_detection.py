"""Tests for `_can_open_graphical_browser()` in xiuqo_cli.auth.

Guards the fix for the May 2026 report where `xiuqo auth add xai-oauth`
...
from xiuqo_cli.auth import _can_open_graphical_browser
