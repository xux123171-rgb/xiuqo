"""Tests for the interactive session browser (`xiuqo sessions browse`).
...
from xiuqo_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """xiuqo sessions browse should be parseable."""
