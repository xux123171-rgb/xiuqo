...
only when every damaged object is a Xiuqo FTS shadow.
"""
...
from xiuqo_cli.doctor_report import Finding
from xiuqo_cli.doctor_state import _state_db_health
from xiuqo_state import SessionDB
from xiuqo_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `xiuqo sessions recover` for THIS
