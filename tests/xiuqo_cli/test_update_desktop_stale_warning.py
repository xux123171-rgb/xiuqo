...
#88251: ``xiuqo update`` treated a failed desktop pack as non-fatal, printed
...
import xiuqo_cli.update_cmd_maint as update_cmd_maint
...
def desktop_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "xiuqo_constants.with_hermes_node_path", lambda: {}, raising=False
    )
    monkeypatch.setattr(
        "xiuqo_constants.display_hermes_home", lambda: str(tmp_path), raising=False
    )
