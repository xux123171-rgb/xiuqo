...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/xux123171-rgb/xiuqo/issues/23994:
    reply_to_mode 'off' was ignored when sending via Xiuqo-created DM topic
...
class TestDMTopicSyntheticSendRouting:
    ...
    Regression tests for https://github.com/xux123171-rgb/xiuqo/issues/87051:
    ...
    response in a different chat lane than the Xiuqo topic the session runs
    in. The no-anchor branch must prefer the Xiuqo topic's
