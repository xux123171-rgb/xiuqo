...
@pytest.mark.parametrize(
    ("cmdline", "expected"),
    [
        ("/v/python -m xiuqo_cli.main -p ops-2 gateway run", False),
        ("/v/python -m xiuqo_cli.main --profile ops2 gateway run", False),
        ("/v/python -m xiuqo_cli.main -p ops gateway run", True),
        ("/v/python -m xiuqo_cli.main --profile=ops gateway run", True),
    ],
)
