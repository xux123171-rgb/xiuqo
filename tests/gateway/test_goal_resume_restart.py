...
class TestCliResumeRestartsWork:
    def test_resume_after_budget_exhaustion_queues_continuation(self, xiuqo_home):
    ...
    def test_resume_without_goal_queues_nothing(self, xiuqo_home):
...
class TestGatewayResumeRestartsWork:
    ...
    @pytest.mark.asyncio
    async def test_resume_without_goal_enqueues_nothing(self, xiuqo_home):
        runner, adapter = _make_runner()
