...
def _patch_aborted_startup(monkeypatch, runner_cls):
    ...
    monkeypatch.setattr("xiuqo_logging.setup_logging", lambda xiuqo_home, mode: None)
...
async def test_failure_exit_still_stops_cron_housekeeping_and_mcp(monkeypatch):
    ...
    monkeypatch.setattr("xiuqo_cli.nous_auth_keepalive.stop_nous_auth_keepalive", lambda: None)
