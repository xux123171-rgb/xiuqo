...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "xiuqo_approve_once" in action_ids
        assert "xiuqo_approve_session" in action_ids
        assert "xiuqo_approve_always" in action_ids
        assert "xiuqo_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_truncates_inflated_original_text(self):
        ...
        action = {"action_id": "xiuqo_approve_once", "value": "session-key"}
