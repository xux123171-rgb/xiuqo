"""Tests for _setup_feishu() in xiuqo_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("xiuqo_cli.config.save_env_value", side_effect=mock_save), \
         patch("xiuqo_cli.config.get_env_value", side_effect=mock_get), \
         patch("xiuqo_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("xiuqo_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("xiuqo_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("xiuqo_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("xiuqo_cli.cli_output.print_header"), \
         patch("xiuqo_cli.cli_output.print_info"), \
         patch("xiuqo_cli.cli_output.print_success"), \
         patch("xiuqo_cli.cli_output.print_warning"), \
         patch("xiuqo_cli.cli_output.print_error"), \
