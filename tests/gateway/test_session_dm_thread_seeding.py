...
def store(tmp_path, monkeypatch):
    ...
    ~/.xiuqo/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at xiuqo_state import time, before pytest's XIUQO_HOME monkeypatch
    fires — the autouse fixture's XIUQO_HOME override doesn't help here.)
    """
    import xiuqo_state
