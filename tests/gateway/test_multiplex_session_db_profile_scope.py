...
def multiplex_homes(tmp_path, monkeypatch):
    """A root home plus a named profile home, with XIUQO_HOME on the root.
    ...
    # The suite-wide fixture in conftest re-points ``xiuqo_state.DEFAULT_DB_PATH``
    ...
    # which is what production does.  ``XIUQO_HOME`` above still keeps that
