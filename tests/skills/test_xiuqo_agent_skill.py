"""The `xiuqo` skill is what a running Xiuqo knows about itself.

`website/` is never packaged, so an installed Xiuqo has no local copy of the
user guide; skills ARE synced into `$XIUQO_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Xiuqo can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "xiuqo"
