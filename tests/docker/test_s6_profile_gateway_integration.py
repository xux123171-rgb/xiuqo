...
The unit tests in tests/xiuqo_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned xiuqo-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/xiuqo")
from xiuqo_cli.service_manager import S6ServiceManager
