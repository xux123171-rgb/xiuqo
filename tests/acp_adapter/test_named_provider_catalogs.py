...
class TestNamedCustomProviderCatalogs:
    ...
    def test_live_discovery_extends_declared_models(self, monkeypatch):
        ...
        with patch("xiuqo_cli.config.load_config", return_value=cfg), patch(
            "xiuqo_cli.model_switch_providers._fetch_picker_live_models",
    ...
    def test_disabled_provider_skipped(self, monkeypatch):
        ...
        with patch("xiuqo_cli.config.load_config", return_value=cfg), patch(
            "xiuqo_cli.model_switch_providers._fetch_picker_live_models", return_value=None
        ):
