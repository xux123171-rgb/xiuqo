...
window keeps moving through the long silent stretches (`xiuqo update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["XIUQO_SELFTEST_HOLD_SECONDS"] = "30"
    ...
    try:
        ...
        # boot default instead ('Xiuqo will open once done.' ==
