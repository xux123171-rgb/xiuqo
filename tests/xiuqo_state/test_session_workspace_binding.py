"""Session <-> workspace grouping key (xiuqo_state_sessions.workspace_key).

The key is what `xiuqo sessions list --workspace` groups/filters on. It is a
...
import xiuqo_state_sessions
from xiuqo_state_sessions import workspace_key
