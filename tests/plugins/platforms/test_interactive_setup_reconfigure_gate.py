...
gate through ``xiuqo_cli.setup_platforms.declines_reconfigure``.
...
import xiuqo_cli.setup_platforms as setup_platforms_mod
...
def test_declining_reconfigure_goes_through_shared_gate(monkeypatch, tmp_path, module_name, env_var):
    ...
    # xiuqo_cli.setup. Everything else a wizard could do after declining must not happen.
