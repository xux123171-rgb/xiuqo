"""Plugin data paths follow the active profile's XIUQO_HOME, including the ContextVar override.

Several plugins carried a ``~/.xiuqo`` fallback (guarding an ImportError of ``xiuqo_constants``
