...
Run from the PR worktree:
    ...
    cd ~/.xiuqo/xiuqo/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.xiuqo/xiuqo``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.xiuqo/xiuqo
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a xiuqo checkout"
)
...
# Isolated XIUQO_HOME for the config write.
