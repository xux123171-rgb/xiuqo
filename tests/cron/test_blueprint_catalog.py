...
the shared /blueprint command handler (xiuqo_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated XIUQO_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("xiuqo://blueprint/morning-brief?")
