...
def cron_store(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(J, "XIUQO_DIR", xiuqo_home)
    monkeypatch.setattr(J, "CRON_DIR", xiuqo_home / "cron")
    monkeypatch.setattr(J, "JOBS_FILE", xiuqo_home / "cron" / "jobs.json")
    monkeypatch.setattr(J, "OUTPUT_DIR", xiuqo_home / "cron" / "output")
