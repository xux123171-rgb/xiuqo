...
class NousProfile(ProviderProfile):
    ...
    def _cannot_disable_reasoning(model: str | None) -> bool:
        ...
        try:
            from xiuqo_cli.models_reasoning_caps import nous_model_reasoning_capabilities, warm_nous_reasoning_caps_async
...
nous = NousProfile(
    ...
    display_name="Nous Research", description="Nous Research — Xiuqo model family",
