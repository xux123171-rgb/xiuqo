...
via :func:`xiuqo_cli.runtime_provider.resolve_runtime_provider`. OpenRouter alone also
...
_ATTRIBUTION_HEADERS = {
    ...
    "HTTP-Referer": "https://github.com/xux123171-rgb/xiuqo",
    "X-Title": "Xiuqo Agent",
}
        ...
        **kwargs: Any,
        ...
        if not api_key or not base_url:
            return fail(
                ...
                f"Configure {self._display} in `xiuqo tools` → Image Generation.",
                "missing_api_key")
