...
``$XIUQO_HOME/photon/sidecar``. The mirror is refreshed by content compare; ``node_modules``
...
# Written by `xiuqo photon install-sidecar` on npm failure so check_requirements() can
