...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {"title": "Xiuqo Agent", "message": content[:self.MAX_MESSAGE_LENGTH]}
...
# xiuqo_cli/gateway.py, and the _send_email dispatch in tools/send_message_tool.py. EMAIL_*
