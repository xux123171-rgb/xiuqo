...
def interactive_setup() -> None:
    ...
    from xiuqo_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where Xiuqo delivers cron job results and notifications.",
    ...
    print_info("   Open config in your editor:  xiuqo config edit")
