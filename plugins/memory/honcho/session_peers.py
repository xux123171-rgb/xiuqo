...
# Author ids the bot-mode dispatcher assigns to other Xiuqo profiles (tools/bot_relay.py).
...
def assistant_peer_id_for(config: Any) -> str:
    ...
    return sanitize_peer_id(getattr(config, "ai_peer", None) or "xiuqo-assistant")
