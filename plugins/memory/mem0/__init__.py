...
self-hosted Mem0 server (MEM0_HOST, HTTP), or OSS Memory. Secrets live in $XIUQO_HOME/.env
(MEM0_API_KEY, MEM0_HOST); settings in $XIUQO_HOME/mem0.json via `xiuqo memory setup`:
...
def _load_config() -> dict:
    """Env vars provide defaults; $XIUQO_HOME/mem0.json overrides individual keys.
    ...
    config = {"mode": get_secret("MEM0_MODE", "") or "platform", "host": get_secret("MEM0_HOST", "") or "",
              "agent_id": get_secret("MEM0_AGENT_ID", "") or "xiuqo", "oss": {}}
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._mode, self._api_key, self._host, self._user_id, self._agent_id = "platform", "", "", _DEFAULT_USER_ID, "xiuqo"
    ...
    def save_config(self, values, xiuqo_home):
        """Merge-write config to $XIUQO_HOME/mem0.json."""
        config_path = Path(xiuqo_home) / "mem0.json"
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "xiuqo-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "xiuqo"},
            {"key": "rerank", "description": "Enable reranking for recall", "default": "false", "choices": ["true", "false"]},
        ]

    def post_setup(self, xiuqo_home: str, config: dict) -> None:
        from ._setup import post_setup
        post_setup(xiuqo_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._mode, self._api_key, self._host, self._agent_id = cfg.get("mode", "platform"), cfg.get("api_key", ""), cfg.get("host", ""), cfg.get("agent_id", "xiuqo")
