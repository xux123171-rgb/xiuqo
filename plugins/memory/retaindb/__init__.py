...
class _Client:
    ...
    def _headers(self, path: str, json_body: bool = True) -> dict:
        ...
        return {"Authorization": f"Bearer {token}", "x-sdk-runtime": "xiuqo-plugin",
...
class RetainDBMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._user_id, self._session_id, self._agent_id = "default", "", "xiuqo"
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        # Project: RETAINDB_PROJECT > config.yaml > xiuqo-<profile> > "default" (API auto-creates "default").
        ...
        if not project:
            profile_name = os.path.basename(str(kwargs.get("xiuqo_home", "")))
            project = f"xiuqo-{profile_name}" if profile_name not in {"", ".xiuqo"} else "default"
        ...
        self._agent_id = kwargs.get("agent_id", "xiuqo") or "xiuqo"
