#!/usr/bin/env python3
"""Build the Xiuqo Skills Index — a centralized JSON catalog of all skills.
...
`xiuqo skills search/install` can use it without hitting the GitHub API.
...
# Ensure XIUQO_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Xiuqo Skills Index...", flush=True)
