#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Xiuqo logs.
...
With no LOGFILE, reads ``$XIUQO_HOME/logs/agent.log`` (default ~/.xiuqo).
...
def default_log() -> Path:
    home = os.environ.get("XIUQO_HOME") or str(Path.home() / ".xiuqo")
