...
def main() -> None:
    ...
    xiuqo_home = Path(tempfile.mkdtemp(prefix="xiuqo-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "xiuqo-gateway-smoke",
    ...
    print(json.dumps({"xiuqo_home": str(xiuqo_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
