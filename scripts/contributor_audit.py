...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Xiuqo\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (xiuqo-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "xiuqo@nousresearch.com",
    "xiuqo-audit@example.com",
    "nousbot@nousresearch.com",
    "xiuqo@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
