#!/usr/bin/env python3
"""Build the Xiuqo Model Catalog — a centralized JSON manifest of curated models.
...
Xiuqo CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Xiuqo release.
...
# Ensure XIUQO_HOME is set for imports that touch it at module level.
os.environ.setdefault("XIUQO_HOME", os.path.join(os.path.expanduser("~"), ".xiuqo"))

from xiuqo_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Xiuqo '
