...
Registry of record: `xiuqo_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Xiuqo config+state snapshots (CLI)
