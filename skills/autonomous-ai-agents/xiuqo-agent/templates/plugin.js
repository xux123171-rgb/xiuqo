/**
 * Xiuqo desktop plugin template. Save as:
 *   <xiuqo home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <xiuqo home> is ~/.xiuqo by default, or ~/.xiuqo/profiles/<name>
 * when running a named profile (`xiuqo -p <name>`). Run `xiuqo doctor` (or
 ...
 * Only these imports resolve: @xiuqo/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@xiuqo/plugin-sdk'
