...
This skill is separate from the Xiuqo Email gateway adapter. The gateway
adapter lets people email the agent and uses Xiuqo' built-in IMAP/SMTP
...
To reply non-interactively from Xiuqo, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Xiuqo)** — pipe the message via stdin:
