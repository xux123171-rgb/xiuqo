...
def _cwd_prefix_filter(value: str) -> Tuple[List[str], list]:
    from xiuqo_state_sessions import _cwd_prefix_clause
...
class SessionMaintenanceMixin:
    ...
    def vacuum(self) -> int:
        ...
        with self._lock:
            # PASSIVE, not TRUNCATE: a manual `xiuqo sessions vacuum` runs in a transient CLI
    ...
    def maybe_auto_prune_and_vacuum(
        ...
        """
        from xiuqo_state_repair import _release_auto_maintenance_lock, _try_acquire_auto_maintenance_lock
