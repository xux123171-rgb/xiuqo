...
(``~/.xiuqo/sticker_cache.json``) so the same image is never re-analyzed.
"""
...
def _resolve_cache_path() -> Path:
    ...
    it, else live profile-scoped XIUQO_HOME — under the multiplexed gateway one process serves
