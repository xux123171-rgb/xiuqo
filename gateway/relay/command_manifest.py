...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Xiuqo session"),
        ...
        _cmd("status", "Show Xiuqo session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Xiuqo agent"),
        ...
        _cmd("update", "Update Xiuqo Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Xiuqo gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Xiuqo session in it",
