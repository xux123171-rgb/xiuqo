...
class GatewayGoalCommandsMixin:
    ...
    async def _handle_goal_command(self, event: MessageEvent) -> str:
        ...
        from xiuqo_cli.goals import last_user_message_from_db
    ...
    async def _handle_heartbeat_command(self, event: MessageEvent) -> str:
        ...
        from xiuqo_cli.heartbeat import parse_interval, format_interval, MIN_INTERVAL_SECONDS
        ...
        return (
            ...
            "elapsed. Lives while the gateway runs — use `xiuqo cron` for durable schedules."
        )
    ...
    async def _handle_loop_command(self, event: MessageEvent) -> str:
        ...
        try:
            from xiuqo_cli.loops import LoopManager, dispatch_loop_command, goal_blocks_loop_tick
        except Exception as exc:
