...
class PlatformConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PlatformConfig":
        ...
        # write them where the docs and ``xiuqo config set platforms.webhook.port`` put them:
...
class GatewayConfig:
    ...
    # route); XIUQO_ROOM_LINK_URL overrides.
...
def load_gateway_config() -> GatewayConfig:
    """Load gateway configuration. Priority: env > ~/.xiuqo/config.yaml > legacy gateway.json > defaults."""
