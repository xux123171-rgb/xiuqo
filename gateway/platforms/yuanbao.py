...
from gateway.platforms.yuanbao_proto import (
    CMD_TYPE, WS_HEARTBEAT_RUNNING, WS_HEARTBEAT_FINISH, XIUQO_INSTANCE_ID,
...
_APP_VERSION = _BOT_VERSION = _XIUQO_VERSION
_YUANBAO_INSTANCE_ID = str(XIUQO_INSTANCE_ID)
...
class YuanbaoAdapter(BasePlatformAdapter):
    ...
    # Per Xiuqo home: a multiplexed gateway runs one Yuanbao adapter per profile, and the tools /
    ...
    def get_active(cls) -> Optional["YuanbaoAdapter"]:
        ...
        return cls._active_instances.get(xiuqo_home_key())
    ...
    def set_active(cls, adapter: Optional["YuanbaoAdapter"]) -> None:
        ...
        if get_hermes_home_override() is None:
            ...
            cls._active_instances.pop(xiuqo_home_key(), None)
        else:
            cls._active_instances[xiuqo_home_key()] = adapter
