...
# `require_mention: true` without custom aliases uses Xiuqo wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?xiuqo\s+agent\b[,:\-]?", r"(?<![\w@])@?xiuqo\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Xiuqo defaults)."""
