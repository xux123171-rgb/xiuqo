...
class GatewayBusySessionMixin:
    ...
    def _get_max_concurrent_sessions(self) -> Optional[int]:
        ...
        try:
            from xiuqo_cli.active_sessions import resolve_max_concurrent_sessions
    ...
    def _active_session_limit_message(self, session_key: str) -> Optional[str]:
        ...
        if active_count < max_sessions:
            return None
        from xiuqo_cli.active_sessions import active_session_limit_message
    ...
    _SECURITY_METADATA_KEYS = (
        "xiuqo_plugin_id", "xiuqo_plugin_injection", "gateway_session_key",
    ...
    def _busy_steer_ack_enabled(self, event: MessageEvent, session_key: str) -> bool:
        ...
        steer_ack_env = os.environ.get("XIUQO_GATEWAY_BUSY_STEER_ACK_ENABLED")
    ...
    async def _handle_active_session_busy_message(self, event: MessageEvent, session_key: str) -> bool:
        ...
        if os.environ.get("XIUQO_GATEWAY_BUSY_ACK_ENABLED", "true").lower() != "true":
    ...
    # busy_handler key (xiuqo_cli/commands.py CommandDef) → mid-run variant ``_busy_<key>_command``.
    ...
    async def _busy_goal_command(self, event: MessageEvent, quick_key: str, source):
        ...
        from xiuqo_cli.goal_command import is_goal_control
    ...
    async def _handle_blueprint_command(self, event: MessageEvent):
        ...
        try:
            ...
            from xiuqo_cli.blueprint_cmd import BlueprintCommandResult
