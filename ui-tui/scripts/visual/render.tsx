 ...
 * across theme x background scenes to <tmpdir>/xiuqo-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@xiuqo/ink'
...
// The regenerated slate light_colors block from xiuqo_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/xiuqo',
...
const setup = (bgHex: string) => {
  process.env.XIUQO_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
