...
await build({
  ...
  // Skip the prebuilt @xiuqo/ink bundle and inline the source instead:
  ...
  alias: { '@xiuqo/ink': resolve(root, 'packages/xiuqo-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The xiuqo_cli launcher
