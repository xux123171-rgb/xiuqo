import type { UsageModelData } from '@xiuqo/shared/billing'
import type {
  GatewayEvent,
  GatewayEventName,
  ...
  SessionInflightTurn,
  Usage
} from '@xiuqo/shared/gateway-events'
import type { HermesSkin } from '@xiuqo/shared/skin'

import type { SessionInfo, SlashCategory } from './types.js'

/** The cross-surface skin contract (canonical shape in `@xiuqo/shared`).
...
// Wire shapes now live in @xiuqo/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
