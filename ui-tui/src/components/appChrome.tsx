import { Box, type ScrollBoxHandle, stringWidth, Text } from '@xiuqo/ink'
import { compactNumber } from '@xiuqo/shared/format'
import type { Usage } from '@xiuqo/shared/gateway-events'
...
export function StatusRule({
  ...
  // Dev-only readout (XIUQO_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (XIUQO_DEV_CREDITS), lowest priority,
