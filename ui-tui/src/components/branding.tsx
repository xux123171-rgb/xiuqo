import { Box, Text, useStdout } from '@xiuqo/ink'
import { mix } from '@xiuqo/shared/color'
...
const TAG_FULL = 'Open-source terminal AI agent · xiuqo.dev'
const TAG_MID = 'Open-source terminal AI agent'
const TAG_TINY = 'xiuqo'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  // xiuqo_cli/banner.py) and the "connected" label on the collapse toggle.
    ...
    <Box flexDirection="column" width="100%">
      ...
      {typeof info.update_behind === 'number' && info.update_behind > 0 && (
        <Text bold color={t.color.warn}>
          ...
          <Text bold color={t.color.warn}>
            {info.update_command || 'xiuqo update'}
          </Text>
          <Text bold={false} color={t.color.warn} dimColor>
            {' '}
            to update
