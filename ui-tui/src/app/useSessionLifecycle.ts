...
import type { ScrollBoxHandle } from '@xiuqo/ink'
import { evictInkCaches } from '@xiuqo/ink'
import type { SessionInflightTurn, SessionResumeResponse, Usage } from '@xiuqo/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.XIUQO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
