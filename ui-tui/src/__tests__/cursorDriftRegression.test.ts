 ...
 *
 * Symptom: in `xiuqo --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@xiuqo/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using xiuqo --tui and as i type multiline my caret at the end will often ' +
