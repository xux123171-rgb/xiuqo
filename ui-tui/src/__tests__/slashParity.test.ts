...
import { parseSlashCommand } from '@xiuqo/shared/slash'
  ...
  try {
    const names = JSON.parse(
      execFileSync(
        ...
        [
          '-c',
          'import json; from xiuqo_cli.commands import COMMAND_REGISTRY; print(json.dumps([c.name for c in COMMAND_REGISTRY]))'
        ],
