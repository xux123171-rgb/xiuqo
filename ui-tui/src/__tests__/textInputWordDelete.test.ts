...
import { InputEvent } from '../../packages/xiuqo-ink/src/ink/events/input-event.js'
import { INITIAL_STATE, parseMultipleKeypresses } from '../../packages/xiuqo-ink/src/ink/parse-keypress.js'
...
// web/src/lib/pty-keyboard-shortcuts.ts). xiuqo-ink decodes that bare
