...
class SlashCommandsMixin:
    ...
    _COMMANDS: dict[str, tuple[str, str, str | None]] = {
        ...
        "version": ("Show Xiuqo version", "Show Xiuqo version", None),
    }
    ...
    def _handle_slash_command(self, text: str, state: SessionState) -> str | None:
        ...
        # and ``/model`` REBUILD the system prompt, so unpinned they'd bake the Xiuqo install tree
    ...
    def _cmd_tools(self, args: str, state: SessionState) -> str:
        try:
            ...
            toolsets = _expand_acp_enabled_toolsets(getattr(state.agent, "enabled_toolsets", None) or ["xiuqo-acp"])
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"Xiuqo Agent v{XIUQO_VERSION}"
